...
if ((!empty($conf->global->EASYA_ONLY_SHOW_PUBLIC_TICKET_EF) || !in_array('ticketpublicview', $hookmanager->contextarray)) && empty($reshook) && isset($extrafields->attributes[$object->table_element]['label']) && is_array($extrafields->attributes[$object->table_element]['label'])) {
