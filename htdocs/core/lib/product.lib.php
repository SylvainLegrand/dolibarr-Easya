...
if (($object->isProduct() || ($object->isService() && !empty($conf->global->STOCK_SUPPORTS_SERVICES))) && $object->stockable_product == Product::ENABLED_STOCK) {    // If physical product we can stock (or service with option)
