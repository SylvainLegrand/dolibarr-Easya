		...
		if ($action != 'edit' && $action != 're-edit') {
			...
			if (($action == 'add_price' || $action == 'update_price') && $usercancreate) {
				...
				if ($rowid) {
					...
					print '<input class="flat width150" maxlength="255" name="ref_fourn" value="'.$object->ref_supplier.'">';
				} else {
					print '<input class="flat width150" maxlength="255" name="ref_fourn" value="'.(GETPOST("ref_fourn") ? GETPOST("ref_fourn") : '').'">';
				}
				print '</td>';
				print '</tr>';
