...
if ($result) {
	...
	// Variables
	$account_supplier = getDolGlobalString('ACCOUNTING_ACCOUNT_SUPPLIER', ''); // NotDefined is a reserved word
	$account_customer = getDolGlobalString('ACCOUNTING_ACCOUNT_CUSTOMER', ''); // NotDefined is a reserved word
	$account_employee = getDolGlobalString('SALARIES_ACCOUNTING_ACCOUNT_PAYMENT', ''); // NotDefined is a reserved word
